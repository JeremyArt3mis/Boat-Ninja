...
#player visual
player_up = pygame.transform.scale(pygame.image.load("player_up.png"),(size,size))
player_down = pygame.transform.scale(pygame.image.load("player_down.png"),(size,size))
player_right = pygame.transform.scale(pygame.image.load("player_right.png"),(size,size))
player_left = pygame.transform.scale(pygame.image.load("player_left.png"),(size,size))
player_shadow = pygame.transform.scale(pygame.image.load("player_shadow.png"),(size,(size / 3 )))
...
light = pygame.transform.scale(pygame.image.load("light.png"),(600,550))
backround_y = 0
...
def keyboard_input():
    ...
    global player_x,player_y,player_direction,player_PE,player_y_spd,jumping,jump_start,player_z_spd,size_y
...
def draw():
    keys = pygame.key.get_pressed()
    global obj_player,obj_enemy,obj_shadow,player_z,boats,backround_y,touching_boat,player_alive,size
    ...
    if not touching_boat and player_z == 0:
        player_alive = False
    if not player_alive:
        if not keys[pygame.K_SPACE] == True:
            death()
        #else:
            #update_camera(1)
            #size = player_size
...
while True:
    clock.tick(60) 
    player_direction = player_up
    player_up = pygame.transform.scale(pygame.image.load("player_up.png"),(size,size * size_y))
    player_down = pygame.transform.scale(pygame.image.load("player_down.png"),(size,size * size_y))
    player_right = pygame.transform.scale(pygame.image.load("player_right.png"),(size,size * size_y))
    player_left = pygame.transform.scale(pygame.image.load("player_left.png"),(size,size * size_y))
    player_shadow = pygame.transform.scale(pygame.image.load("player_shadow.png"),(size,(size / 3 )))
    event_handler()
    if player_alive:
        keyboard_input()
